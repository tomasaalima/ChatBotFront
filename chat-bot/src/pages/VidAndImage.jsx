        ...
        <>
            ...
            >
                    ...
                    >
                        ...
                        <div 
                            className="flex flex-col w-11/12 h-4/6 items-center justify-center mt-28"
                        >
                            <nav 
                            ...
                            >
                                {activeTab === "tab1" && (
                                    <div 
                                        className="h-full w-full grid grid-cols-2 gap-x-4 text-black"
                                    >
                                        <Video 
                                            link="https://www.youtube.com/embed/H2bKVI7eS4s" 
                                            description="Joji"
                                        >
                                        </Video>
                                        <Video 
                                            link="https://www.youtube.com/embed/wjEzE6HSgWo" 
